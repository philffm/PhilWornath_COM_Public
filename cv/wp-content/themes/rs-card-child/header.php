...
<head>
	...
	})(window,document,'script','dataLayer','GTM-TWKS437');</script>
...
<body <?php body_class();?>>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TWKS437"
    ...
    <div id="mobile-nav" class="mobile-nav-inner">
        <?php if( $has_lang || $has_sidebar || $has_woo ){ ?>
            <div class="head-items">
                <?php if($has_woo):	?>
                    <a class="head-woo" href="<?php echo esc_url(WC()->cart->get_cart_url()); ?>">
